<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecoverPassword.aspx.cs" Inherits="EnvoyDelivery.RecoverPassword" %>
    ...
    <div class="container">
       <div class="form-horizontal">
           ...
           <div class="form-group">
               <asp:Label runat="server" ID="lblMsg" CssClass="col-md-2 control-label" Text="New Password" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
            </div>   

           <div class="form-group">
               <asp:Label runat="server" ID="lblPassword" CssClass="col-md-2 control-label" Text="New Password" Visible="False"></asp:Label>
               <div class="col-md-3">
                   <asp:TextBox runat="server" ID="tbNewPass" TextMode="Password" class="form-control" Visible="False"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorPass" runat="server" CssClass="text-danger" ErrorMessage="Please enter your new Password !" ControlToValidate="tbNewPass"></asp:RequiredFieldValidator>
               </div>
           </div>

            <div class="form-group">
               <asp:Label runat="server" ID="lblRetypePass" CssClass="col-md-2 control-label" Text="Confirm Password" Visible="False"></asp:Label>
               <div class="col-md-3">
                   <asp:TextBox runat="server" ID="tbConfirmPass" TextMode="Password" class="form-control" Visible="False"></asp:TextBox>
           ...
           <div class="form-group">
               ...
               <div class="col-md-6">
                   <asp:Button runat="server" ID="btRecPass" class="btn btn-default" Text="Reset" Visible="False" OnClick="btRecPass_Click"/>
               </div>
           </div>
       </div>
    </div>
